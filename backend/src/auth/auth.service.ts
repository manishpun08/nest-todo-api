...
export class AuthService {
  ...
  async validateUser(
    ...
    if (user?.password && (await bcrypt.compare(pass, user.password as string))) {
  ...
  async refreshTokens(userId: string, refreshToken: string) {
    ...
    const refreshTokenMatches = await bcrypt.compare(refreshToken, user.refreshToken as string);
